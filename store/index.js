    ...
    promotions: [
      {
        title:'ogóriki',
        type:'pikling',
        src: ['https://images.unsplash.com/photo-1568584711271-6c929fb49b60?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1172&q=80',
              'https://images.unsplash.com/photo-1566486189376-d5f21e25aae4?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=867&q=80',],
        crops: ['bjorn', 'severin'],
        terms: '5 + 1 gratis',
        color: '#2B6034',
        endTime: '2022-03-31',
...
export const actions = {
  ...
  setSearchPhrase({commit}, searchPhrase){
    commit('setSearchPhrase', searchPhrase.toLowerCase() || "")
  }
}
