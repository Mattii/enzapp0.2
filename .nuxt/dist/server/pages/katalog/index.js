...
module.exports.__inject__ = function (context) {
  add("1e1473ea", content, true, context)
};
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".top-card-bar{display:flex;width:100%;top:0;position:absolute;padding:.9rem;justify-content:space-between;align-items:center}.chip{border:2px solid #fff;border-radius:.6rem;font-weight:900;padding:.4rem}.takiiLogo{border-radius:.6rem;right:0;width:3rem;float:right}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/katalog/index.vue?vue&type=template&id=7931610b&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-row',{attrs:{"justify":"center","align":"center"}},[_c('v-col',{attrs:{"cols":"12","sm":"8","md":"6"}},[_c('v-card',{staticClass:"pt-3"},[_c('v-img',{staticClass:"white--text align-end my-3",attrs:{"src":"hero.jpg","gradient":"to bottom, rgba(0,0,0,.1), rgba(0,0,0,.5)","height":"250px"}},[_c('v-card-title',{staticClass:"text-h4"},[_vm._v("Twoje odmiany")]),_vm._v(" "),_c('v-card-subtitle',{staticClass:"subtitle-1"},[_vm._v("zawsze pod ręką")])],1)],1),_vm._v(" "),_vm._l((_vm.varieties),function(v,key){return _c('v-card',{key:key,staticClass:"mx-auto mt-9 rounded-sm",attrs:{"loading":_vm.loading,"elevation":"6","nuxt":"","to":{ name: 'katalog-id', params: { id: v.id } }}},[_c('template',{slot:"progress"},[_c('v-progress-linear',{attrs:{"color":"green","height":"10","indeterminate":""}})],1),_vm._v(" "),_c('v-img',{staticClass:"white--text align-end",attrs:{"height":"250","gradient":"to bottom, rgba(0,0,0,.01), rgba(0,0,0,.5)","src":v.imgs[0],"dark":""}},[_c('div',{staticClass:"top-card-bar"},[(v.new)?_c('div',{staticClass:"chip"},[_vm._v("NEW")]):_vm._e(),_vm._v(" "),(v.provider == 'takii')?_c('img',{staticClass:"takiiLogo",attrs:{"src":"/takiiLogoCut.png"}}):_vm._e()]),_vm._v(" "),_c('v-card-subtitle',{staticClass:"pb-0"},[_vm._v(_vm._s(v.segment))]),_vm._v(" "),_c('v-card-title',{staticClass:"text-h4 text-uppercase pt-0"},[_vm._v(_vm._s(v.name)+" "+_vm._s(v.hybrid ? 'F1' : ''))]),_vm._v(" "),_c('v-card-subtitle',{},[_vm._v(" "+_vm._s(v.type || '?')+" ")])],1)],2)})],2)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/katalog/index.vue?vue&type=template&id=7931610b&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/katalog/index.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var katalogvue_type_script_lang_js_ = ({
  name: 'katalog',
...
// CONCATENATED MODULE: ./pages/katalog/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var pages_katalogvue_type_script_lang_js_ = (katalogvue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./pages/katalog/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_katalogvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var katalog = __webpack_exports__["default"] = (component.exports);
...
installComponents_default()(component, {VCard: VCard["a" /* default */],VCardSubtitle: components_VCard["b" /* VCardSubtitle */],VCardTitle: components_VCard["d" /* VCardTitle */],VCol: VCol["a" /* default */],VImg: VImg["a" /* default */],VProgressLinear: VProgressLinear["a" /* default */],VRow: VRow["a" /* default */]})
