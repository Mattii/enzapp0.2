...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".test{width:100%}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/index.vue?vue&type=template&id=15d596b0&
var lib_vue_loader_options_pagesvue_type_template_id_15d596b0_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-sheet',[_c('v-row',{attrs:{"justify":"center","align":"center"}},[_c('v-col',{attrs:{"cols":"12","sm":"8","md":"6"}},[_c('v-card',{staticClass:"mt-6"},[_c('v-img',{staticClass:"white--text align-end",attrs:{"src":_vm.card.src,"gradient":"to bottom, rgba(0,0,0,.1), rgba(0,0,0,.5)","height":"250px"}},[_c('v-card-title',{staticClass:"headline",domProps:{"textContent":_vm._s(_vm.card.title)}}),_vm._v(" "),_c('v-card-subtitle',{staticClass:"pb-0"},[_vm._v("twoje odmiany na wyciągniecie ręki")]),_vm._v(" "),_c('v-card-actions',[_c('v-btn',{staticClass:"ma-2 pa-3 white--text",attrs:{"nuxt":"","justify":"center","outlined":"","rounded":"","small":"","to":{ name: 'katalog' }}},[_vm._v("\n              Zapoznaj się...\n            ")])],1)],1)],1),_vm._v(" "),_c('v-subheader',{staticClass:"mt-3"},[_vm._v("promocje...")]),_vm._v(" "),_vm._l((_vm.promos),function(promo){return _c('v-card',{key:promo.title,staticClass:"overflov-hiden mb-5",attrs:{"to":{ name: 'promocja-id', params: { id: promo.title } },"elevation":"7","color":promo.color,"dark":""}},[_c('div',{staticClass:"test d-flex flex-no-wrap justify-space-between"},[_c('div',{staticClass:"test align-self-center align-stretch"},[_c('v-card-title',{staticClass:"headline pb-0 justify-center text-uppercase",domProps:{"textContent":_vm._s(promo.title)}}),_vm._v(" "),_c('v-card-title',{staticClass:"headline pt-0 justify-center",domProps:{"textContent":_vm._s(promo.terms)}}),_vm._v(" "),_c('v-card-title',{staticClass:"font-weight-light pa-1 justify-center"},[_vm._v(_vm._s(_vm.promotionCounter(promo.endTime)))])],1),_vm._v(" "),_c('v-avatar',{attrs:{"size":"150","tile":""}},[_c('v-carousel',{attrs:{"delimiter-icon":"mdi-minus","show-arrows":false,"cycle":"","interval":"6000","height":"150","hide-delimiters":""}},_vm._l((promo.src),function(item,i){return _c('v-carousel-item',{key:i,attrs:{"width":"150","src":item,"gradient":"to bottom, rgba(0,0,0,.1), rgba(0,0,0,.3)"}},[_c('v-card-title',{staticClass:"\n                    headline\n                    align-end\n                    subtitle-1\n                    font-weight-light\n                    text-uppercase\n                  ",domProps:{"textContent":_vm._s(promo.crops[i])}})],1)}),1)],1)],1)])}),_vm._v(" "),_c('v-subheader',{staticClass:"mt-3"},[_vm._v("nasze odmiany...")]),_vm._v(" "),_vm._l((_vm.cards),function(card){return _c('v-card',{key:card.title,staticClass:"mx-auto mb-7"},[_c('v-img',{attrs:{"src":card.src,"height":"200px"}}),_vm._v(" "),_c('v-card-title',{staticClass:"text-uppercase"},[_vm._v(" "+_vm._s(card.title)+" ")]),_vm._v(" "),_c('v-card-subtitle',[_vm._v(" "+_vm._s(_vm.toFullCrop(card.crop))+" ")]),_vm._v(" "),_c('v-card-actions',[_c('v-btn',{attrs:{"aria-label":"expand text","icon":""},on:{"click":function($event){card.show = !card.show}}},[_c('v-icon',[_vm._v(_vm._s(card.show ? 'mdi-chevron-up' : 'mdi-chevron-down'))])],1)],1),_vm._v(" "),_c('v-expand-transition',[_c('div',{directives:[{name:"show",rawName:"v-show",value:(card.show),expression:"card.show"}]},[_c('v-divider'),_vm._v(" "),_c('v-card-text',[_vm._v("\n              I'm a thing. But, like most politicians, he promised more than\n              he could deliver. You won't have time for sleeping, soldier, not\n              with all the bed making you'll be doing. Then we'll go with that\n              data file! Hey, you add a one and two zeros to that or we walk!\n              You're going to do his laundry? I've got to find a way to\n              escape.\n            ")])],1)])],1)})],2)],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/index.vue?vue&type=template&id=15d596b0&

// EXTERNAL MODULE: ./components/Logo.vue + 2 modules
var Logo = __webpack_require__(163);

// EXTERNAL MODULE: ./components/EzappLogo.vue + 2 modules
var EzappLogo = __webpack_require__(164);
...
/* harmony default export */ var lib_vue_loader_options_pagesvue_type_script_lang_js_ = ({
  ...
  methods: {
    promotionCounter(endTime) {
      ...
      return `${this.toDubleDiget(monthT)}m :${this.toDubleDiget(dayT)}d :${this.toDubleDiget(hourT)}h :${this.toDubleDiget(minT)}m :${this.toDubleDiget(secT)}s`;
    },
...
var VAvatar = __webpack_require__(39);
...
var VDivider = __webpack_require__(174);
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  lib_vue_loader_options_pagesvue_type_template_id_15d596b0_render,
  staticRenderFns,
  false,
  injectStyles,
  null,
...
installComponents_default()(component, {VAvatar: VAvatar["a" /* default */],VBtn: VBtn["a" /* default */],VCard: VCard["a" /* default */],VCardActions: components_VCard["a" /* VCardActions */],VCardSubtitle: components_VCard["b" /* VCardSubtitle */],VCardText: components_VCard["c" /* VCardText */],VCardTitle: components_VCard["d" /* VCardTitle */],VCarousel: VCarousel_VCarousel,VCarouselItem: VCarouselItem,VCol: VCol["a" /* default */],VDivider: VDivider_VDivider,VExpandTransition: transitions["a" /* VExpandTransition */],VIcon: VIcon_VIcon["a" /* default */],VImg: VImg["a" /* default */],VRow: VRow["a" /* default */],VSheet: VSheet["a" /* default */],VSubheader: VSubheader["a" /* default */]})
